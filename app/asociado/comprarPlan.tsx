...
// --- MOCK: Componente HeaderMenu simulado para evitar errores de importación en esta vista previa ---
// En tu proyecto real, descomenta la siguiente línea y borra este componente Mock:
